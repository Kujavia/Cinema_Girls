export const movieListContainer = document.getElementById("movie-list2");
let currentIndex = 0;
let itemsPerView = 1;
...
export async function fetchSeries() {
  ...
  try {
    const response = await fetch(
      "https://kinopoiskapiunofficial.tech/api/v2.2/films/collections?type=VAMPIRE_THEME&page=1",
...
export function initSeriesModule2() {
  fetchSeries();
  const arrow = document.getElementById("arrow_2");
